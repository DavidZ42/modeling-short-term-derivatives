...
# --- Configuration ---
EVENT_SLUG = "bitcoin-up-or-down-on-march-27-2026"
TZ = ZoneInfo("America/New_York")

# Target dates: March 26, 2026 12:00 PM ET to March 27, 2026 12:00 PM ET
START_TIME = datetime(2026, 3, 26, 12, 0, tzinfo=TZ)
END_TIME = datetime(2026, 3, 27, 12, 0, tzinfo=TZ)
...
def write_to_csv(history_data, filename="polymarket_btc_up_prices.csv"):
...
def main():
    ...
    try:
        ...
        print(f"Success! {len(history)} minutely data points saved to polymarket_btc_up_prices.csv")
